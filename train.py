...
def setup_train_args():
    ...
    parser.add_argument('--dialogue_model_output_path', default='dialogue_model/', type=str, required=False,
                        help='对话模型输出路径')
    parser.add_argument('--pretrained_model', default='pretrained/', type=str, required=False, help='预训练的GPT2模型的路径')
...
def create_model(args, vocab_size):
    ...
    :return:
    """
    model = TransformerVAE(n_ctx=n_ctx, vocab_size=vocab_size, pretrained_decoder=args.pretrained_model)
    return model
