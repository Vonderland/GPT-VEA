...
def create_model(args, vocab_size):
    ...
    :return:
    """
    model = BGVAE(vocab_size=vocab_size, decoder_config=args.decoder_config, word_dropout=args.word_dropout, with_bow=(not args.without_bow), repr_form=args.repr_form)
    return model
